                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeC">
                                   ...
                                   <td>
                                        <a class="btn btn-info" href="<?php  echo base_url();?>edit-category/<?php echo $value->category_id;?>">Sửa</a>
                                        <a class="btn btn-danger" href="<?php  echo base_url();?>delete-category/<?php echo $value->category_id;?>">Xóa</a>
                                    </td> 
