        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Tên khách hàng: <?php echo $contact_message_by_id->contact_name?> & Email: <?php echo $contact_message_by_id->contact_email?></h4>
                   <h4 class="modal-title" id="myModalLabel">Mục đích:<?php echo $contact_message_by_id->contact_subject?></h4>
                </div>
                <div class="modal-body">
                	<strong>Tin nhắn:</strong><hr/>
                   <?php echo $contact_message_by_id->contact_message?>
                  
                </div>
                <div class="modal-footer">
                    <button type="button" onclick="myFunction()" class="btn btn-default" data-dismiss="modal">Đóng</button>
                    <a href="<?php  echo base_url();?>delete-contact/<?php echo $contact_message_by_id->contact_id;?>" type="button" class="btn btn-primary">Xóa tin nhắn</a>
