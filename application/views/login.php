         ...
         <div class="panel-body">
            <form role="form" action="<?php echo base_url();?>Login/checklogin" method="post">
                <fieldset>
                    ...
                    <div class="checkbox">
                        <label>
                            <input name="remember" type="checkbox" value="Remember Me">Nhớ lựa chọn của rôi
                        </label>
                    </div>
                    <button class="btn btn-lg btn-success btn-block" name="remember" type="checkbox" value="Remember Me">Đăng nhập</button>
                </fieldset>
            </form>
        </div>
    </div>
